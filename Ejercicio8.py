# 8) Crear una tupla en Python con el nombre de “Historial4” la cual contenga los siguientes
# valores:  7510, 7960, 76180, 800, 4100
...
print("Valor mínimo de atención de Olivia : ", min(Historial4));

#Antonio Armando Alvarado